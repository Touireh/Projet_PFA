...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card card-primary card-outline">
              ...
              <!-- /.card-header -->
              <form action="{{ route('courrier.send') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <textarea id="compose-textarea" class="form-control" style="height: 300px" name="content"></textarea>
        </div>
        <div class="form-group">
